...
const UploadJob = () => {
  ...
  return (
    <div className='container mt-10 mx-auto flex justify-center md:flex-row gap-8 2xl:gap-14 bg-indigo-100 px-5'>
      <div className='w-full h-fit md:w-2/3 2xl:2/4 bg-indigo-50 px-5 py-10 md:px-10 shadow-md'>
        <div>
          <p className='text-indigo-500 flex justify-center font-semibold text-2xl'>Create New Job Post</p>
          ...
          >
            ...
            <div className='mt-2'>
              <CustomButton
                type='submit'
                containerStyles='inline-flex justify-center rounded-md border border-transparent bg-indigo-600 px-8 py-2 text-sm font-medium text-white hover:bg-indigo-700  focus:outline-none '
                title='Sumbit'
              />
            </div>
          </form>
