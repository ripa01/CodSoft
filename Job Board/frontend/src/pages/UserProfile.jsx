...
const UserForm = ({ open, setOpen }) => {
  ...
  const onSubmit = async (data) => {
    setIsSubmitted(true);  // Corrected this line
    ...
    try {
      ...
      if (res) {
        ...
        localStorage.setItem("userInfo", JSON.stringify(updatedData));  // Corrected this line
      ...
      setIsSubmitted(false);  // Ensure the submission state is reset
    }
  };
                ...
                <DialogPanel className='w-full max-w-md transform overflow-hidden rounded-2xl bg-indigo-100 p-6 text-left align-middle shadow-xl transition-all'>
                  ...
                  >
                    ...
                    <div className='w-full flex gap-2 text-sm'>
                      <div className='w-1/2'>
                        <label className='text-gray-600 text-sm mb-4'>
                          Profile Picture
                        </label>
                        <input
                          type='file'
    ...
    <div className='container min-h-screen mx-auto flex items-center justify-center py-10'>
      <div className='w-full md:w-2/3 2xl:w-2/4 bg-indigo-50 shadow-lg p-10 pb-20 rounded-lg'>
        ...
        <div className='w-full py-10'>
          ...
          <button
                className='w-1/2 md:w-64 bg-indigo-600 text-white mt-4 py-2 rounded'
